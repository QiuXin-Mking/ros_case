...
def main():
    ...
    theMap.addEdge(56, 46)
    theMap.addEdge(36, 46)
    theMap.addEdge(36, 26)

    theMap.addEdge(26, 25)
    theMap.addEdge(25, 24)
    theMap.addEdge(23, 24)

    theMap.addEdge(45, 44)
    theMap.addEdge(45, 46)

    theMap.addEdge(23, 33)
    theMap.addEdge(43, 33)

    theMap.addEdge(56, 57)

    theMap.addEdge(57, 58)
    theMap.addEdge(58, 68)
    theMap.addEdge(78, 68)
    theMap.addEdge(78, 88)
    theMap.addEdge(98, 88)


    theMap.addEdge(98, 97)
    theMap.addEdge(97, 96)
    theMap.addEdge(96, 95)
    theMap.addEdge(94, 95)
    theMap.addEdge(94, 93)
    theMap.addEdge(92, 93)
    theMap.addEdge(92, 91)
    theMap.addEdge(90, 91)

    theMap.addEdge(90, 80)
    theMap.addEdge(70, 80)
    theMap.addEdge(70, 60)
    theMap.addEdge(50, 60)
    theMap.addEdge(50, 51)
    theMap.addEdge(52, 51)
    theMap.addEdge(52, 53)

    theMap.addEdge(92, 82)
    theMap.addEdge(72, 82)

    theMap.addEdge(91, 81)
    theMap.addEdge(71, 81)

    theMap.addEdge(83, 93)

    # 初始化迷宫
    theMap.initMap()

    # A* 算法寻路
    theAstar = Astar(theMap, 86, 53)
    theAstar.find_way()
    theAstar.show_way()
